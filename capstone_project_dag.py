...
with DAG("CapstoneProject", 
    ...
    create_postgres = PostgresOperator(task_id='CreatePostgresDatabase',
                         sql="""
    ...
    download_gcs_file = GCSToLocalFilesystemOperator(task_id="DownloadCSV",
